...
<div style="color: black;">
    ...
    {if isset($recurringContributionData) and $recurringContributionData}
        ...
        <table style="border-collapse: collapse;border: 1px solid black; max-width: 600px; width: 100%;">
            ...
            <tr style="border: 1px solid black;">
                <td style="border: 1px solid black;padding-left: 10px;"><p style="color: black;"><strong>{ts}General Membership{/ts}</strong></p></td>
    ...
    {if isset($mandateData) and $mandateData}
        ...
        <table>
            ...
            <tr>
                ...
                <td style="padding-left: 10px;"><span style="color: black;">{$mandateData.Postcode}</span></td>
            </tr>
            <tr>
    ...
    {if isset($membershipData) and $membershipData}
        ...
        {if isset($nextMembershipPayment) and $nextMembershipPayment}
            ...
            <div>
                <p style="color: black;">{ts 1=$nextMembershipPayment.amount 2=$nextMembershipPayment.date|date_format:"%Y.%m.%d" 3=$currency }Your next payment of %3%1 will be collected on %2{/ts}</p>
            </div>
